...
cliconf: staros
short_description: Use ios cliconf to run command on Cisco StarOS platform
description:
  - This staros plugin provides low level abstraction apis for
    sending and receiving CLI commands from Cisco StarOS network devices.
version_added: "2.4"
"""
...
class Cliconf(CliconfBase):
    ...
    def get_defaults_flag(self):
        ...
        """
        out = self.get('show configuration ?')
